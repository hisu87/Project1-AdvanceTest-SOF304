...
public class HoaDonChiTietDAO extends CafeDAO<HoaDonChiTiet, String> {
    ...
    public String DELETE_SQL = "DELETE FROM [CHITIETDONHANG] WHERE MaHD=?";
    public String SELECT_ALL_SQL = "SELECT * FROM [CHITIETDONHANG]";
    public String SELECT_BY_ID_SQL = "SELECT * FROM [Hóa Đơn] WHERE MaHD=?";
